package practice_2.command;

import practice_2.command.executor.*;
...
public class CommandReader {
    ...
    private static final Map<CommandType, CommandExecutor> COMMAND_EXECUTORS_GROUPED_BY_COMMAND = Map.of(
            CommandType.CREATE_TEXTBOOK, new TextBookCreate(),
            CommandType.DELETE_TEXTBOOK, new TextBookRemove(),
            CommandType.CREATE_STUDENT, new StudentCreate(),
            CommandType.DELETE_STUDENT, new StudentRemove(),
